<?php 
// Функция для отправки писем с формы "БЕСПЛАТНАЯ КОНСУЛЬТАЦИЯ"
...
$mail->isHTML(true);
$mail->Subject = 'Мои Тендеры - Бесплатная консультация'; // Тема письма
$mail->Body    = '' .$text. ' - Сообщение пользователя<br>' .$name. ' - Имя<br>' .$email. ' - Почта этого пользователя ';
$mail->AltBody = '';
